...
- Update dependency type-fest to v5.8.0 ([#319](https://github.com/ChristianIvicevic/intl-watcher/pull/319)) by [@renovate](https://github.com/apps/renovate)

## 1.3.2

### Patch Changes

- Update dependency lodash to v4.18.1 ([#276](https://github.com/ChristianIvicevic/intl-watcher/pull/276)) by [@renovate](https://github.com/apps/renovate)

- Update dependency type-fest to v5.6.0 ([#295](https://github.com/ChristianIvicevic/intl-watcher/pull/295)) by [@renovate](https://github.com/apps/renovate)

- Update dependency ts-morph to v28 ([#297](https://github.com/ChristianIvicevic/intl-watcher/pull/297)) by [@renovate](https://github.com/apps/renovate)
...
- Update dependency type-fest to v5.5.0 ([#258](https://github.com/ChristianIvicevic/intl-watcher/pull/258)) by [@renovate](https://github.com/apps/renovate)

- Fix module resolution for consumers using CJS loaders (e.g. tsx) by adding an `exports` field with correct relative `./` prefixes for all entry points. ([#262](https://github.com/ChristianIvicevic/intl-watcher/pull/262)) by [@ChristianIvicevic](https://github.com/ChristianIvicevic)
